...
[![codecov](https://codecov.io/gh/stormasm/noms/branch/master/graph/badge.svg)](https://codecov.io/gh/stormasm/noms)
[![GoDoc](https://godoc.org/github.com/stormasm/noms?status.svg)](https://godoc.org/github.com/stormasm/noms)
...
We are fairly confident in the core data format, and plan to support Noms database [version `7`](https://github.com/stormasm/noms/blob/master/go/constants/version.go#L8) and forward. If you create a database with Noms today, future versions will have migration tools to pull your databases forward.
