...
var nomsCommit = &util.Command{
	...
	Long:      "If absolute-path is not provided, then it is read from stdin. See Spelling Objects at https://github.com/stormasm/noms/blob/master/doc/spelling.md for details on the dataset and absolute-path arguments.",
